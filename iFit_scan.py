...
#========================================================================================
         ...
         # Build text box
        self.text_box = tkst.ScrolledText(text_frame, width = 55, height = 8)
        ...
        stop_b = ttk.Button(text_frame, text = 'Stop', command = lambda: stop(self))
...
#========================================================================================
        ...
        model_frame = tk.LabelFrame(setup_frame, text = 'File Selection',
                                    font = LARG_FONT)
...
#========================================================================================
        ...
        # Add dropdown to select the type of scanner
        self.scanner_type = tk.StringVar(value = settings['scanner_type'])
        make_input(frame = model_frame,
                   text = 'Scanner type:',
                   var = self.scanner_type,
                   input_type = 'OptionMenu',
                   row = 1,
                   column = 1,
                   options = [settings['scanner_type'], 'FLAME', 'Open SO2'])
            ...
            if err == 0:
                ...
                with open(out_file, 'w') as w:
                    ...
                    for n in range(1, len(spec_block)):
                        ...
                        for parameter in ['so2', 'no2', 'o31', 'bro', 'ring']:
