...
def adv_settings(self, settings, version):
    ...
    def update_settings(settings, close_flag):
        ...
        settings['o31_amt']          = popup.o31_amt.get()
        settings['o32_amt']          = popup.o32_amt.get()
        ...
        settings['Fit o31']          = popup.o31_amt_c.get()
        settings['Fit o32']          = popup.o32_amt_c.get()
        ...
        settings['o31_path']         = popup.o31_path.get()
        settings['o31_temp']         = popup.o31_temp.get()
        settings['o32_path']         = popup.o32_path.get()
        settings['o32_temp']         = popup.o32_temp.get()
        ...
        if version == 'iFit':
            ...
            self.ax3.set_ylabel(gas_choice[gas.get()] + ' OD', fontsize=10)
...
#====================================== Parameters ======================================
    ...
    popup.o31_amt = tk.DoubleVar(model_frame, value = settings['o31_amt'])
    make_input(frame = model_frame,
               text = 'O3 (1):',
               row = row_n, column = col_n,
               var = popup.o31_amt,
               input_type = 'Entry',
               width = 12)
    popup.o31_amt_c = tk.StringVar(model_frame, value = settings['Fit o31'])
    fit_options[0] = settings['Fit o31']
    o31_c = ttk.OptionMenu(model_frame, popup.o31_amt_c, *fit_options)
    o31_c.config(width = 6)
    o31_c.grid(row = row_n, column = col_n+2, padx = 5, pady = 5)
    row_n += 1

    popup.o32_amt = tk.DoubleVar(model_frame, value = settings['o32_amt'])
    make_input(frame = model_frame,
               text = 'O3 (2):',
               row = row_n, column = col_n,
               var = popup.o32_amt,
               input_type = 'Entry',
               width = 12)
    popup.o32_amt_c = tk.StringVar(model_frame, value = settings['Fit o32'])
    fit_options[0] = settings['Fit o32']
    o32_c = ttk.OptionMenu(model_frame, popup.o32_amt_c, *fit_options)
    o32_c.config(width = 6)
    o32_c.grid(row = row_n, column = col_n+2, padx = 5, pady = 5)
    row_n += 1
...
#========================================================================================
    ...
    # O3 1 xsec
    popup.o31_path = tk.StringVar(datab_frame, value = settings['o31_path'])
    make_input(frame = datab_frame,
               text = 'O3 (1) Path:',
               row = row_n, column = col_n,
               var = popup.o31_path,
               ...
               width = 40,
               command = build_fwd_model)
    o31_path_b = ttk.Button(datab_frame, text = "Browse",
                            command = lambda: update_fp(popup.o31_path))
    o31_path_b.grid(row = row_n, column = 2, padx = 5, pady = 5, sticky = 'W')

    # O3 1 Temp
    temp_options = [settings['o31_temp'], '298K', '283K', '273K', '263K', '253K', '243K',
                    '233K', '223K', '213K', '203K', '193K']
    popup.o31_temp = tk.StringVar(datab_frame, value = settings['o31_temp'])
    o31_temp_c = ttk.OptionMenu(datab_frame, popup.o31_temp, *temp_options,
                              command = build_fwd_model)
    o31_temp_c.grid(row = row_n, column = 3, padx = 5, pady = 5)
    row_n += 1

    # O3 2 xsec
    popup.o32_path = tk.StringVar(datab_frame, value = settings['o32_path'])
    make_input(frame = datab_frame,
               text = 'O3 (2) Path:',
               row = row_n, column = col_n,
               var = popup.o32_path,
               ...
               width = 40,
               command = build_fwd_model)
    o32_path_b = ttk.Button(datab_frame, text = "Browse",
                            command = lambda: update_fp(popup.o32_path))
    o32_path_b.grid(row = row_n, column = 2, padx = 5, pady = 5, sticky = 'W')

    # O3 2 Temp
    temp_options = [settings['o32_temp'], '298K', '283K', '273K', '263K', '253K', '243K',
                    '233K', '223K', '213K', '203K', '193K']
    popup.o32_temp = tk.StringVar(datab_frame, value = settings['o32_temp'])
    o32_temp_c = ttk.OptionMenu(datab_frame, popup.o32_temp, *temp_options,
                                command = build_fwd_model)
    o32_temp_c.grid(row = row_n, column = 3, padx = 5, pady = 5)
    row_n += 1
